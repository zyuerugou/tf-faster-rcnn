...
# Initial learning rate defalut = 0.001
...
# The scale is the pixel size of an image's shortest side, default = (600,), my = (375,)
__C.TRAIN.SCALES = (375,)

# Max pixel size of the longest side of a scaled input image, default = 1000, my = 1242
__C.TRAIN.MAX_SIZE = 1242
...
# Propose boxes, default = False, my = True
