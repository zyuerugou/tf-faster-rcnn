...
def kitti_ap(rec, prec):
  """ ap = kitti_ap(rec, prec)
  Compute kitti AP given precision and recall.
...
def kitti_eval(detpath,
  ...
  Top level function that does the KITTI evaluation.
